...
public class Comparator_Q1_SortArrayByIncreasingFrequency {
...
//		[(1, 1), (2, 2), (3, 3)]
	...
	public static void main(String[] args) {
		int[] nums = {2, 3, 1, 3, 2, 3, 3};
		int[] result = new Comparator_Q1_SortArrayByIncreasingFrequency().frequencySort(nums);
